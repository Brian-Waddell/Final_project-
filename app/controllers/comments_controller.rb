class CommentsController < ApplicationController
  ...
  def create
    ...
    the_comment.likes = params.fetch("query_likes")
    the_comment.dislikes = params.fetch("query_dislikes")
    the_comment.questions_id = params.fetch("query_questions_id")
    the_comment.participant_id = params.fetch("query_participant_id")
